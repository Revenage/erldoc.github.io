(function () {
    ...
    */
    ...
    var author$project$App$Types$Loading = {$: 'Loading'};
    ...
    var author$project$Main$getTranslation = elm$http$Http$get(
    	{
    ...
    var author$project$App$Types$Doc = function (modulesummary) {
    	return {modulesummary: modulesummary};
    };
    var elm$json$Json$Decode$field = _Json_decodeField;
    var author$project$App$Decoders$decodeDocument = A2(
    	elm$json$Json$Decode$field,
    	'erlref',
    	A2(
    		elm$json$Json$Decode$map,
    		author$project$App$Types$Doc,
    		A2(elm$json$Json$Decode$field, 'modulesummary', elm$json$Json$Decode$string)));
    var author$project$Main$HandleDocResponse = function (a) {
    	return {$: 'HandleDocResponse', a: a};
    };
    var author$project$Main$getDoc = function (name) {
    ...
    var author$project$Main$HandleTagResponse = function (a) {
    	return {$: 'HandleTagResponse', a: a};
    };
    ...
    var author$project$Main$initialRequests = function (url) {
    	...
    	switch (route.$) {
    		...
    		case 'Document':
    			var name = route.a;
    			return author$project$Main$getDoc(name);
    		default:
    			return elm$core$Platform$Cmd$none;
    	}
    };
    var author$project$Main$loadPageData = function (url) {
    	return elm$core$Platform$Cmd$batch(
    		A2(
    			...
    			_List_fromArray(
    				[
    					author$project$Main$initialRequests(url)
    				])));
    };
    		...
    		return _Utils_Tuple2(
    			{
    				...
    				settings: A2(
    					...
    					flags.settings),
    				translation: author$project$App$Types$Loading,
    				url: url
    			},
    			author$project$Main$loadPageData(url));
    	});
    ...
    var author$project$App$Types$Failure = {$: 'Failure'};
    var author$project$App$Types$Success = function (a) {
    	return {$: 'Success', a: a};
    };
    var author$project$App$Types$TagSuccess = function (a) {
    	return {$: 'TagSuccess', a: a};
    };
    var author$project$Main$requestOnUrlChanged = function (url) {
    	var route = author$project$App$Router$toRoute(url);
    	switch (route.$) {
    		case 'Document':
    			var name = route.a;
    	...
    	function (msg, model) {
    		switch (msg.$) {
    			...
    			case 'UrlChanged':
    				...
    				return _Utils_Tuple2(
    					_Utils_update(
    						model,
    						{url: url}),
    					author$project$Main$requestOnUrlChanged(url));
    				...
    				if (result.$ === 'Ok') {
    					...
    					return _Utils_Tuple2(
    						_Utils_update(
    							model,
    							{
    								translation: author$project$App$Types$Success(translation)
    							}),
    					...
    					return _Utils_Tuple2(
    						_Utils_update(
    							model,
    							{translation: author$project$App$Types$Failure}),
    						elm$core$Platform$Cmd$none);
    				}
    			case 'HandleDocResponse':
    				...
    				if (result.$ === 'Ok') {
    					var doc = result.a;
    					var l = A2(elm$core$Debug$log, 'Aadf', doc.modulesummary);
    					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
    				} else {
    					var err = result.a;
    					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
    				}
    			case 'HandleTagResponse':
    				var result = msg.a;
    				if (result.$ === 'Ok') {
    					var tags = result.a;
    ...
    var author$project$Main$checkColapse = F2(
    	function (baseclass, model) {
    		return _Utils_eq(
    			author$project$App$Router$toRoute(model.url),
    			author$project$App$Router$Settings) ? A2(
    			elm$core$String$join,
    			' ',
    			_List_fromArray(
    	...
    	return A2(
    		...
    		_List_fromArray(
    			[
    				...
    				_List_fromArray(
    					[
    						elm$html$Html$Attributes$href('/docs/' + item)
    					]),
    				_List_fromArray(
    					[
    					...
    					[
    						...
    						_List_fromArray(
    							[
    								...
    								_List_fromArray(
    									[
    										elm$html$Html$text('Back to Docs')
    									]))
    							]))
    					]))
    			]),
    								...
    								[
    									...
    									_List_fromArray(
    										[
    											...
    											elm$html$Html$Attributes$checked(model.settings.darkMode),
    									...
    									_List_fromArray(
    										[
    											...
    											A2(elm$html$Html$Attributes$attribute, 'data-off', 'Light theme'),
    											A2(elm$html$Html$Attributes$attribute, 'data-on', 'Dark theme'),
    ...
    var author$project$Main$view = function (model) {
    	...
    	switch (_n0.$) {
    		case 'Loading':
    			return {body: author$project$Main$loader, title: 'Loading'};
    		case 'Success':
    			...
    			var _n1 = author$project$App$Router$toRoute(model.url);
    			switch (_n1.$) {
    				case 'Home':
    		...
    		default:
    			return {body: author$project$Main$loader, title: 'Failure'};
    	}
    };
    		...
    		A2(
    			...
    			elm$json$Json$Decode$oneOf(
    				_List_fromArray(
    					...
    					])))))(0)}});}(this)); }).call(output); var App = output.Elm;
